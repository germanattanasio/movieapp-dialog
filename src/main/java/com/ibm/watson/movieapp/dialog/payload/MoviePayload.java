 ...
 * <P>
 * This is a payload class which carries all the info associated with a movie.
 * It is instantiated in {@code SearchTheMovieDbProxyResource} and subsequently passed onto {@code WDSBlueMixProxyResource} for sending across to the client-side for rendering movie information.
 * @author Ashima Arora
 */
