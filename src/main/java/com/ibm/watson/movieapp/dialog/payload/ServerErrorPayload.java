...
/**
 * <P>
 * Information associated with an exception in the server code.
 * This class is instantiated when an exception is caught in {@code SearchTheMovieDbProxyResource} and {@code WDSBlueMixProxyResource}. This object is sent as payload to the client-side for displaying error messages to the user.
 * @author Ashima Arora
 *
 */
